...
For Games: do NOT use, or closely paraphrase, a "What do you want/hope to find in a game library?" rhetorical-question opener - that specific opener has been overused across reviews. Pick a genuinely different opening-sentence style for this section (a number-first sentence, a verdict-first sentence, a specific-provider callout, or something else you invent).
